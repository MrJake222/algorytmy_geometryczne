...
P = [Point(-2, -2), Point(4, 3)] 
	...
	\subsection{Algorytm wyznaczania widocznych wierzchołków dla punktu $ p $} \label{sssec:algo}
		...
		\subsection{Testy losowe}
			...
			\imgcustomsize{test-losowe4.jpg}{25 figur na płaszczyźnie 3 x 31}{1}
			\imgcustomsize{test-losowe5.jpg}{50 figur na płaszczyźnie 3 x 31}{1}
			\imgcustomsize{test-losowe6.jpg}{100 figur na płaszczyźnie 3 x 31}{1}
