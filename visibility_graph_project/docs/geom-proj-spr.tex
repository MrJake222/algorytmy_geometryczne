...
\begin{document}
	...
	\subsection{Algorytm wyznaczania widocznych wierzchołków dla punktu $ p $} \label{sssec:algo}
		...
		\subsection{Testy}
			...
			\imgcustomsize{test1.png}{Przypadek testowy}{0.75}
			...
			\imgcustomsize{test2.png}{Przypadek testowy}{0.75}
			...
			\imgcustomsize{test3.png}{Przypadek testowy}{0.75}
			...
			\imgcustomsize{test6.png}{Przypadek testowy}{0.75}
